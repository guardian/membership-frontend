...
class CheckoutFormTest extends Specification {
  ...
  val plans = PaidMembershipPlans[Partner.type](
    month = CatalogPlan(ProductRatePlanId(""), Product.Membership, "Partner", "Partner", None, PaidCharge(Partner, BillingPeriod.Month, pricingSummary, ProductRatePlanChargeId("prpcId"), SubscriptionRatePlanChargeId("srpcid")), Status.current),
    year = CatalogPlan(ProductRatePlanId(""), Product.Membership, "Partner", "Partner", None, PaidCharge(Partner, BillingPeriod.Year, pricingSummary, ProductRatePlanChargeId("prpcId"), SubscriptionRatePlanChargeId("srpcid")), Status.current)
  )
