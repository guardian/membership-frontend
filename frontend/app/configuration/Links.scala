...
object Links {
  ...
  val guardianLiveTerms =
    "http://www.theguardian.com/info/2014/sep/09/guardian-live-events-terms-and-conditions"
  val guardianMasterclassesTerms =
    "http://www.theguardian.com/guardian-masterclasses/terms-and-conditions"

  val membershipFront = "http://www.theguardian.com/membership"

  val membershipTerms =
    "http://www.theguardian.com/info/2014/sep/09/guardian-membership-terms-and-conditions"
  val membershipContact =
    "http://www.theguardian.com/help/contact-us#Membership"

  val membershipPollyToynbeeArticle =
...
object ProfileLinks {
  ...
  val editProfileMembership =
    Config.idWebAppUrl / "membership/edit" ? Config.idMember
