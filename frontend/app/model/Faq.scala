...
object Faq {
  ...
  val staff = List(
      Item(
          "I already have a profile set up on theguardian.com, can I use that?",
      ...
      Item(
          "Can I use social sign in/registration?",
          Html("No, you must have a Guardian account using your work email address.")),
      Item(
          "I've already joined Guardian Members as a friend, can I upgrade?",
          Html(
              "No, sorry you can't upgrade, you need to cancel your friend membership first.")),
      Item(
          "How do I cancel my friend membership?",
          Html(s"<ol><li>Go to <a href='${Config.membershipUrl +
          "/tier/cancel"}'>${Config.membershipUrl + "/tier/cancel"}</a></li><li>Scroll to the bottom and click 'Cancel membership'.</li></ol>")),
      Item(
          "How do I change the email address saved in my profile on theguardian.com?",
          Html(s"<ol><li>Go to <a href='${Config.idWebAppUrl +
          "/account/edit"}'>${Config.idWebAppUrl + "/account/edit"}</a></li><li>Change the email address to your work email address</li><li>Scroll to the bottom and click 'Save Changes'</li></ol>")),
      Item(
          "How long will staff membership last?",
          Html(
              "Your Guardian Staff Membership will last for a long as you are a permanent member of staff")),
      Item(
          "I've got an additional question that's not listed here",
          Html(
              s"Please email <a href='mailto:${Email.staffMembership}'>${Email.staffMembership}</a> with your question, use Guardian Staff Partners as the Subject. We will do our best to get back to you within 24 hours."))
  )

  val help = List(
      Item(
          "What is Guardian Members?",
          Html(
              "Guardian Members is for you if you share our belief that the open exchange of information, ideas and opinions can change the world for the better. By signing up and paying your subscription (at Partner and Patron level), you are helping bring these words to life by supporting open and independent journalism. In return, you get access to events and experiences that are only available to members.")),
      Item(
          "Why should I join?",
          Html(
              "Membership has a lot to offer and by joining us you can help build and shape Guardian Members into one of the world’s largest communities of free thinkers. Benefits include access to the Guardian live events programme. Events range from lectures by the world’s foremost thinkers to exclusive screenings of the latest independent films; from sessions with senior journalists at our offices in Kings Place to more intimate, bespoke events. Tickets are only available to Guardian members. If you want to support the Guardian and its journalism, and keep our website open to all, then joining Guardian Members and paying your subscription is a great way to do it.")),
      Item(
          "How much does membership cost?",
          Html(
              "The Friend tier of Guardian Members is free. Supporters pay £5 per month or £49 per year. Partners pay £15 per month or £149 per year if you pay in one go. For Patrons, the cost is £60 per month or £599 per year. If you choose the annual payment you get 2 months free. Supporters in the US pay $4.99 per month or $49 per year. If you choose the annual payment you get 2 months free.")),
      ...
      Item(
          "Why do I have to sign in to the Guardian to become a member?",
          Html(
              "We ask you to sign in so we know who you are and ensure that we apply the correct discounts and privileges when you buy tickets to an event - Partners and Patrons get priority booking and 20% discount on tickets to all Guardian Live events.")),
      Item(
          "What is Guardian Live?",
          Html(
              "Guardian Live is a rolling events programme of discussions, debates, interviews and festivals that transform our journalism in print and online into live experiences. Tickets can only be booked by Guardian members.")),
      Item(
          "Can I buy a ticket to a Guardian Live event without becoming a member?",
          Html(
              "You can only buy a ticket to a Guardian Live event if you are a member. Access to these events is one of the benefits we offer members in return for their support. Our basic tier of membership is free.")),
      ...
      Item(
          "How many Guardian Live tickets can I buy for each event?",
          Html(
      ...
      Item(
          "If I choose the Book benefit, which books will I receive and when?",
      ...
      Item(
          "How will I know what Guardian Live events are coming up?",
          Html(
              "Our <a href='events'>events listing page</a> is updated regularly and when you join membership you will receive a weekly email newsletter containing information about upcoming events.")),
      Item(
          "What happens if I don't want to receive the weekly email?",
          Html(
              "If you no longer want to receive the weekly email newsletter, click the unsubscribe link at the bottom of the email.")),
      ...
      Item(
          "I don’t live in the UK - can I still be a member?",
          Html(
              "Yes, Guardian Members is open to anyone living anywhere in the world. And although our home is London, we will be extending membership and staging events for members in the USA and Australia.")),
      Item(
          "What happens if I want to change my membership tier?",
          Html(
              s"You can change your membership tier online. Just go to your <a href='${Config.idWebAppUrl}/membership/edit'>Profile</a> page on the membership site and follow the instructions.")),
      ...
      Item("How do I know you are protecting my personal information?",
           Html(
               "We will never use your information for any purpose without your permission. You can read more about our approach to data security in <a href='http://www.theguardian.com/help/privacy-policy'>our privacy policy</a>.")),
      Item(
      ...
      Item(
          "How can I find out about disabled/wheelchair access for the venue?",
          Html(
      ...
      Item(
          "Where do Guardian Masterclasses take place?",
          Html(
