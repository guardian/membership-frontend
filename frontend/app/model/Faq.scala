...
object Faq {
  ...
  val subscribers = List(
    ...
    Item("When do I need to take up this offer?",
      Html("This offer is open until 17 July 2015. However, we reserve the right at any time to modify or discontinue, temporarily or permanently, this offer without prior notice."),
      "when-start-offer"
    ),
