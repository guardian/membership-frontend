...
trait FrontPage extends Controller {
  ...
  def index = CachedAction { implicit request =>
    ...
    val pageImages = Seq(
        ResponsiveImageGroup(
            name = Some("patrons"),
            metadata = Some(
                  Grid.Metadata(Some("Patrons of The Guardian"), None, None)),
    ...
    Ok(views.html.index(
            TouchpointBackend.Normal.catalog, pageImages, eventCollections))
  }
  ...
  def welcome =
    CachedAction { implicit request =>
      val slideShowImages = Seq(
          ResponsiveImageGroup(
              metadata = Some(Grid.Metadata(
                        description = Some(
                              "RIP Rock and Roll? (Guardian Live event): Emmy the Great"),
                        byline = None,
                        credit = None
                    )),
              availableImages = ResponsiveImageGenerator(
          ...
          ResponsiveImageGroup(
              metadata = Some(Grid.Metadata(
                        description = Some(
                              "A Life in Music - George Clinton (Guardian Live event)"),
                        byline = None,
                        credit = None
                    )),
              availableImages = ResponsiveImageGenerator(
          ...
          ResponsiveImageGroup(
              metadata = Some(Grid.Metadata(
                        description = Some(
                              "A Life in Politics - Ken Clarke (Guardian Live event)"),
                        byline = None,
                        credit = None
                    )),
              availableImages = ResponsiveImageGenerator(
          ...
          ResponsiveImageGroup(
              metadata = Some(Grid.Metadata(
                        description = Some(
                              "Guardian Live event: Pussy Riot - art, sex and disobedience"),
                        byline = None,
                        credit = None
                    )),
              availableImages = ResponsiveImageGenerator(
          ...
          ResponsiveImageGroup(
              metadata = Some(Grid.Metadata(
                        description = Some(
                              "Behind the Headlines - What's all the fuss about feminism? (Guardian Live event): Bonnie Greer"),
                        byline = None,
                        credit = None
                    )),
              availableImages = ResponsiveImageGenerator(
      ...
      Ok(views.html.welcome(PageInfo(title = "Welcome", url = request.path),
                            slideShowImages))
    }
}
