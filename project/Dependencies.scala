...
object Dependencies {
  ...
  val membershipCommon = "com.gu" %% "membership-common" % "0.33.1"
  val playWS = PlayImport.ws
  val playFilters = PlayImport.filters

  //projects
  val frontendDependencies = Seq(identityCookie, identityModel, identityTestUsers, scalaUri, membershipCommon, playWS, playFilters)
}
