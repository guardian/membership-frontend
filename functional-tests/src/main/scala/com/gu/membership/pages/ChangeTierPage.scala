...
class ChangeTierPage(driver: WebDriver) extends BaseMembershipPage(driver) {
  ...
  private def becomeAFriendButton = driver.findElement(By.xpath("//div[1]/div/div/main/div[2]/div[1]/section/div[1]/div[2]/a"))

  private def becomeAPartnerButton = driver.findElement(By.xpath("//div[1]/div/div/main/div[2]/div[1]/section/div[2]/div[2]/a"))

  private def becomeAPatronButton = driver.findElement(By.xpath("//div[1]/div/div/main/div[2]/div[1]/section/div[3]/div[2]/a"))
